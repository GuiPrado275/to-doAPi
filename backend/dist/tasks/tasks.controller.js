...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Listar tarefas do usuário autenticado' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Estatísticas das tarefas do usuário' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, type: task_entity_1.Task }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Não encontrada' }),
...
__decorate([
    ...
    __metadata("design:paramtypes", [Number, user_entity_1.User]),
    __metadata("design:returntype", Promise)
], TasksController.prototype, "markAsDone", null);
__decorate([
