...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Conta criada — retorna token JWT' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Entrar com e-mail e senha' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Login OK — retorna token JWT' }),
